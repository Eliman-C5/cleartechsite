...
export const aboutUsCards = {
  ...
  operations: [
    {
      imgsrc: '/img/icons/knowhow/operations/management.svg',
  ...
  product: [
    {
      imgsrc: '/img/icons/knowhow/product/product.svg',
    ...
    },
    {
      ...
      title: 'Product Landing & Product Owner',
      charlist: [
  ...
  ux: [
    {
      imgsrc: '/img/icons/knowhow/ux/ux.svg',
      title: 'UX design',
      charlist: [
  ...
  quality: [
    {
      imgsrc: '/img/icons/knowhow/quality/test.svg',
  ...
  cloud: [
    {
      imgsrc: '/img/icons/knowhow/cloud/cloud.svg',
